...
for website in websites:
    ...
    if website.startswith("https://trainings.internshala.com") or website.startswith("https://www.cse.iitb.ac.in") :
        count=count+1
        continue
    allLinks = [];mails=[]
    url = website + '/'
    ...
    if(len(mails)==0):
        ...
        writer.writerow([df['Company Name'][count],
                        mails
                    ])
        count=count+1            
        print(mails)    
